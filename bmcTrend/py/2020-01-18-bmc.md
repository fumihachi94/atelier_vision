...
- [2021/03/31](#20210331)
  ...
  - [Mazda : 販売店入庫による無償有線ソフト更新を提供](#mazda--販売店入庫による無償有線ソフト更新を提供)
  - [BMW : iDrive8からADAS機能OTA可能に](#bmw--idrive8からadas機能ota可能に)
- [2021/03/16](#20210316)
  - [Tesla : FSDは買替えで引き継げない](#tesla--fsdは買替えで引き継げない)
  - [Tesla : Tesla-china FSD付き車両の買い替えで次回FSD半額](#tesla--tesla-china-fsd付き車両の買い替えで次回fsd半額)
- [2021/03/08](#20210308)
  - [Other : 自動運転Lv3の動向](#other--自動運転lv3の動向)
  - [VW : ID.3/ID.4にてOTAソフトウェア更新を今夏から欧州で開始](#vw--id3id4にてotaソフトウェア更新を今夏から欧州で開始)
  - [Ford  : Mustang Mach-Eにて一部所有者限定でOTAベータ配信の実施](#ford---mustang-mach-eにて一部所有者限定でotaベータ配信の実施)
  - [Audi : ビッグデータ活用 ~路面状態から警告を行う~](#audi--ビッグデータ活用-路面状態から警告を行う)
- [2021/02/19](#20210219)
  - [Bosch : BoschとMicrosoftが共同でOTA-SUプラットフォームを開発](#bosch--boschとmicrosoftが共同でota-suプラットフォームを開発)
  - [Mercedes : 130万車両のリコールをSU対応（SOS機能）](#mercedes--130万車両のリコールをsu対応sos機能)
- [2021/02/17](#20210217)
  - [Ford : Mustang MACH-EのOTAシステム/HMI](#ford--mustang-mach-eのotaシステムhmi)
  - [Honda : 「天下一品」誤認識問題とOTA技術への期待](#honda--天下一品誤認識問題とota技術への期待)
- [2021/02/04](#20210204)
  - [Other : 韓国発の物体認識ソフト「SVNet」が世界880万車両で採用](#other--韓国発の物体認識ソフトsvnetが世界880万車両で採用)
- [2021/01/31](#20210131)
  - [Tesla : Model-S/X の内装を一新（'21/4 LO予定）](#tesla--model-sx-の内装を一新214-lo予定)
- [2021/01/27](#20210127)
  - [Tesla : FSDをサブスク化することを発表](#tesla--fsdをサブスク化することを発表)
  - [Other : いすゞがCASEでVolvoと連携](#other--いすゞがcaseでvolvoと連携)
- [2021/01/26](#20210126)
  - [Other : ExcelforeのOTAの技術](#other--excelforeのotaの技術)
  - [Honda : GMと国内で自動運転モビリティサービス実証実験開始](#honda--gmと国内で自動運転モビリティサービス実証実験開始)
- [2021/01/19](#20210119)
  - [Mercedes : MM系課金パッケージ](#mercedes--mm系課金パッケージ)
  - [Tesla : MUC欠陥で15.8万台リコール要請](#tesla--muc欠陥で158万台リコール要請)
- [2021/01/18](#20210118)
  - [NIO : et7を発表](#nio--et7を発表)
  - [Nissan : 日産アリアにOTAを導入](#nissan--日産アリアにotaを導入)
  - [Other : Mack TrucksがOTAを導入](#other--mack-trucksがotaを導入)
  - [Other : Sony Vision-S](#other--sony-vision-s)
...
## Tesla : Tesla-china FSD付き車両の買い替えで次回FSD半額
...
## VW : ID.3/ID.4にてOTAソフトウェア更新を今夏から欧州で開始
...
## Ford  : Mustang Mach-Eにて一部所有者限定でOTAベータ配信の実施
...
## Bosch : BoschとMicrosoftが共同でOTA-SUプラットフォームを開発
...
## Other : 韓国発の物体認識ソフト「SVNet」が世界880万車両で採用
